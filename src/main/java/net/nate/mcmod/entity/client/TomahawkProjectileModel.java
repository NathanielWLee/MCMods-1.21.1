...
import net.nate.mcmod.entity.custom.TomahawkProjectileEntity;
...
public class TomahawkProjectileModel extends EntityModel<TomahawkProjectileEntity> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(MCMod.MOD_ID, "tomahawk"), "main");
