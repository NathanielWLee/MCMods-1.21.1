...
import net.nate.mcmod.item.custom.*;
import net.nate.mcmod.item.custom.*;
...
public class ModItems {
    ...
    public static final RegistryObject<Item> KOHLRABI = ITEMS.register("kohlrabi",
            () -> new Item(new Item.Properties().food(ModFoodProperties.KOHLRABI)) {
                ...
                public void appendHoverText(ItemStack pStack, TooltipContext pContext, List<Component> pTooltipComponents, TooltipFlag pTooltipFlag) {
                    pTooltipComponents.add(Component.translatable("tooltip.mcmod.kohlrabi"));
    ...
    public static final RegistryObject<Item> NATHAN_SMITHING_TEMPLATE = ITEMS.register("nathan_armor_trim_smithing_template",
            () -> SmithingTemplateItem.createArmorTrimTemplate(ResourceLocation.fromNamespaceAndPath(MCMod.MOD_ID, "nathan")));

    public static final RegistryObject<Item> NATHAN_BOW = ITEMS.register("nathan_bow",
